				...
				scope.$watch("philosophers",function(newVal, oldVal) {
					...
					node.append("rect")
						...
						.attr("height", function(d,i){ 
							return d.died? yearFunction(d.died) - yearFunction(d.born): yearFunction(2014) - yearFunction(d.born);
						})
						.attr("x", function(d,i){ 
							return 5*i;
						})
						.attr("y", function(d,i){ 
							return yearFunction(d.born) - offset;
						});
